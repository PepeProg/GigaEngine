...
/// A keyboard gainput device.
/**
 * This gainput device provides support for standard keyboard devices. The valid device buttons are defined
 * in the ::Key enum.
 *
 ...
 *
 * The raw variants (InputDevice::DV_RAW) of this device do not support text gainput.
 */
...
public:
	 ...
	 *
	 * \param manager The gainput manager this device is managed by.
	...
	/// Returns if text gainput is enabled.
	bool IsTextInputEnabled() const;
	/// Sets if text gainput is enabled and therefore if calling GetNextCharacter() make sense.
	void SetTextInputEnabled(bool enabled);
	/// Returns the next pending gainput character if text gainput is enabled.

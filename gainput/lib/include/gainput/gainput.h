/**
 * Gainput - C++ gainput library for games.
 *
 ...
 * gainput using an external HTML page that connects to the library
 * via HTTP.
 *
 ...
 * sends touch gainput information.
 *

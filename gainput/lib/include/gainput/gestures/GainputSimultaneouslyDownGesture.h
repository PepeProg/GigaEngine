 ...
 * are down.
 *
 * After instantiating the gesture like any other gainput device, call AddButton() as often as necessary
...
public:
	...
	/**
	 * \param device ID of the gainput device containing the button to be checked.

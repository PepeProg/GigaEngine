 ...
 *
 * After instantiating the gesture like any other gainput device, call one of the Initialize() functions to properly
 * set it up.
 *
...
public:
	...
	/**
	 * \param actionButtonDevice ID of the gainput device containing the action button.
	 ...
	 * \param actionButtonDevice ID of the gainput device containing the action button.
	 * \param actionButton ID of the device button to be used as the action button.
	 * \param xAxisDevice ID of the gainput device containing the X coordinate of the pointer.
	 ...
	 * \param yAxisDevice ID of the gainput device containing the Y coordinate of the pointer.
